/*
Program Name: rotate180.c
Programmer's Name: Sparsh Jain
Description: rotate an image by 180 deg
Date: 05/10/2016
*/
...
int main()
	{
		...
		int width, height, w, h, c, l, maximum, IMG[500][500][3], R[500][500][3];
				...
				for(w = 0; w < width; w++)
					{
						for(c = 0; c < 3; c++)
						{
							R[height - (h + 1)][width - (w + 1)][c] = IMG[h][w][c];
						}
					}
			}		
